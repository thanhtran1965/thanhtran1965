...
Most of my friends are bookworms and sports enthusiasts. Sometimes if I can't solve an algorithm I will ping them and force them to solve it. If they get it right, I'll force them to find the optimal solution. That's how we maintain our friendship.
